...
//This enum is not related to load balancing but rather to general gRPC channel implementation.
...
namespace Grpc.Net.Client
{
    ...
    /// 
    /// See https://github.com/grpc/grpc/blob/master/doc/connectivity-semantics-and-api.md for more information.
    /// </summary>
    public enum GrpcConnectivityState
    {
        /// <summary>
